...
APP_NAME="${APP_NAME:-indezy}"
APP_DISPLAY_NAME="${APP_DISPLAY_NAME:-Indezy}"
PROJECT_DESCRIPTION="${PROJECT_DESCRIPTION:-Freelance opportunity and relationship management application with Spring Boot, Angular, GitOps, and production observability.}"
PROJECT_TOPICS="${PROJECT_TOPICS:-angular,crm,gitops,java,spring-boot}"
