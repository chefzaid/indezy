...
build_image indezy-server "$repository_root/indezy-server" "$repository_root/indezy-server/Dockerfile.runtime"
build_image indezy-web "$repository_root/indezy-web" "$repository_root/indezy-web/Dockerfile.runtime"
