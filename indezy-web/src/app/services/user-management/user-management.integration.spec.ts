...
/**
 * Integration tests for UserManagementService that make actual HTTP calls to the indezy-server.
 * These tests are designed to run against a real indezy-server server.
 */
describe('UserManagementService Integration Tests', () => {
  ...
  // Skip all tests until indezy-server endpoints are implemented
  describe('Profile Management Integration', () => {
    it('should get user profile from indezy-server', (done) => {
    ...
    it('should update user profile via indezy-server', (done) => {
    ...
    it('should upload avatar to indezy-server', (done) => {
  ...
  describe('Password Management Integration', () => {
    it('should change password via indezy-server', (done) => {
      // Handle the constructor request first
      handleConstructorRequest();
  ...
  describe('Preferences Management Integration', () => {
    it('should get user preferences from indezy-server', (done) => {
    ...
    it('should update user preferences via indezy-server', (done) => {
  ...
  describe('Notification Settings Integration', () => {
    it('should get notification settings from indezy-server', (done) => {
    ...
    it('should update notification settings via indezy-server', (done) => {
  ...
  describe('Security Management Integration', () => {
    it('should get security settings from indezy-server', (done) => {
  ...
  describe('Account Management Integration', () => {
    it('should export user data from indezy-server', (done) => {
