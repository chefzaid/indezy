...
export class StepActionDialogComponent {
  ...
  private getSuccessMessage(): string {
    switch (this.data.action) {
      case 'waiting_feedback':
        return this.translate.instant('steps.markedWaitingFeedback');
      case 'validated':
        return this.translate.instant('steps.validated');
      case 'failed':
        return this.translate.instant('steps.markedFailed');
      case 'canceled':
        return this.translate.instant('steps.canceled');
      default:
        return this.translate.instant('steps.statusUpdated');
    }
  }
