-- Local Development Sample Data for Indezy Application (H2 Database)
-- This script populates the H2 database with realistic sample data for local development
-- Only executed in local profile
...
-- H2 with identity columns handles sequences automatically
...
-- Insert Projects
INSERT INTO projects (id, role, description, tech_stack, daily_rate, work_mode, remote_days_per_month, onsite_days_per_month, advantages, start_date, duration_in_months, order_renewal_in_months, days_per_year, link, personal_rating, notes, status, freelance_id, client_id, middleman_id, source_id, created_at, updated_at, version) VALUES
(1, 'Développeur Full Stack Senior', 'Développement d''une application de gestion de commandes pour e-commerce', 'Angular 18, Spring Boot 3, PostgreSQL, Docker', 650, 'HYBRID', 15, 7, 'Équipe jeune et dynamique, technologies modernes, formation continue', '2024-01-15', 6, 3, 220, 'https://techcorp.fr/careers', 5, 'Excellent projet, équipe très compétente. Client très satisfait.', 'WON', 1, 1, NULL, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 0),
(2, 'Architecte Logiciel', 'Refonte de l''architecture microservices existante', 'Java 21, Spring Cloud, Kubernetes, Redis', 750, 'REMOTE', 22, 0, 'Full remote, horaires flexibles, projets innovants', '2024-03-01', 12, 6, 240, NULL, 4, 'Projet complexe mais très enrichissant techniquement.', 'INTERVIEW', 1, 2, NULL, 2, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 0),
(3, 'Lead Developer Frontend', 'Création d''une PWA pour la gestion de stock', 'React 18, TypeScript, PWA, Material-UI', 600, 'ONSITE', 0, 22, 'Locaux modernes, équipe expérimentée, défis techniques', '2024-02-01', 4, 2, 180, 'https://ecommerce-plus.com', 3, 'Projet intéressant mais délais serrés.', 'APPLIED', 1, 3, NULL, 3, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 0),
(4, 'Consultant Technique Senior', 'Audit et optimisation des performances', 'Java, Spring Boot, PostgreSQL, Monitoring', 800, 'HYBRID', 10, 12, 'Missions variées, expertise reconnue, bon réseau', '2024-01-01', 18, 12, 200, NULL, 5, 'Mission de conseil très enrichissante. Client fidèle.', 'WON', 2, 4, NULL, 4, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 0),
(5, 'Développeur Creative Tech', 'Développement d''expériences interactives', 'Vue.js 3, Three.js, WebGL, Node.js', 550, 'HYBRID', 12, 10, 'Projets créatifs, liberté technique, environnement stimulant', '2024-04-01', 8, 4, 190, 'https://digitalagency.com/portfolio', 4, 'Projets très créatifs, équipe talentueuse.', 'OFFER', 2, 5, NULL, 5, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 0),
(6, 'Expert Sécurité FinTech', 'Implémentation de solutions de sécurité bancaire', 'Java 21, Spring Security, OAuth2, Blockchain', 900, 'ONSITE', 0, 22, 'Secteur financier, sécurité maximale, expertise pointue', '2024-05-01', 10, 6, 210, NULL, 4, 'Projet très technique, réglementations strictes mais passionnant.', 'IDENTIFIED', 3, 6, NULL, 6, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 0);
